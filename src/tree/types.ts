...
/**
 * 孤儿节点处理方式, 具体含义请参考 {@link ArrayToTreeOptions} 中的 orphansHandleType 属性说明
 */
...
export interface ArrayToTreeOptions<T> {
   ...
   * 
   * 
   * 孤儿节点: 指某个节点的父节点非空, 且不等于根节点, 且源数组中不包含其父节点的数据<br/>
